...
export default function Personal() {
    ...
    return (
        <section id="personal" className="py-16 md:py-32 px-6 max-w-6xl mx-auto">
            <motion.h2
                className="text-3xl md:text-4xl font-bold text-center mb-12 md:mb-20 text-orange"
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-10 md:gap-32">
                ...
                <div className="flex flex-col items-center">
                    ...
                    <div className="w-70 h-70 md:w-87.5 md:h-87.5">
                        <Stack
                ...
                <AnimatePresence mode="wait">
                    <motion.div
                        ...
                        className="max-w-md min-h-50 flex flex-col justify-center text-center md:text-left"
                    >
